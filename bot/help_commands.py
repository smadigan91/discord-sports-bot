help_map = {
    ...
    "**/last `[num_days: int]` `[player_search: str]`**": "Fetches the last [num_days] worth of stats for a given "
                                                          "player",
    "**/log `[player_search: str]`**": "Fetches the most recent gamelog for a given player",
    "**/season [year: int] `[player_search: str]`**": "fetches current season's (unless otherwise specified) stats for "
                                                      "a given player",
